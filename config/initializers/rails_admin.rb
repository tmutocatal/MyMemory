# RailsAdmin config file. Generated on October 19, 2013 14:12
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Calendar', 'Admin']
  ...
  # config.excluded_models = ['AdminUser', 'Event', 'Image', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['AdminUser', 'Event', 'Image', 'User']
